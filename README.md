...
When an investigation is completed, the **Scribe Agent** and **Detection Engineering Agent** will attempt to mirror the local state and drafted rules to Google SecOps Data Tables. These tables allow human analysts and YARA-L detection rules to utilize the findings generated by the Agentic SOC.
